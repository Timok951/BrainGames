...
{
    public class LevelButtonNumberLinks : MonoBehaviour
    {
        ...
        private void LevelOpened()
        {
            ...
            if (parts.Length > 1 && int.TryParse(parts[parts.Length - 1], out int levelNum))
            {
                ...
                isLevelUnlocked = GameManager.Instance.IsLevelUnlockedNumberLinks(currentLevel);
        ...
        private void Clicked()
        {
            ...
            GameManager.Instance.CurrentLevelNumberLinks = currentLevel;

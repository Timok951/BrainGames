...
{
    /// <summary>
    /// Logic for Paint Level Buttons
    /// </summary>
    public class LevelButtonPaint : MonoBehaviour
    {
        ...
        private void LevelOpened()
        {
            ...
            {
                Debug.LogError("GameManager.Instance is null in LevelButtonPaint");
                return;
            }
            ...
            if (parts.Length > 1 && int.TryParse(parts[parts.Length - 1], out int levelNum))
            {
                ...
                isLevelUnlocked = GameManager.Instance.IsLevelUnlockedPaint(currentLevel);
        ...
        private void Clicked()
        {
            ...
            GameManager.Instance.CurrenLevelPaint = currentLevel;
            GameManager.Instance.GoToGameplayPaint();
        }
    }
}
